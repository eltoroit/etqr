...
/***/ "./node_modules/@lwc/synthetic-shadow/dist/synthetic-shadow.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@lwc/synthetic-shadow/dist/synthetic-shadow.js ***!
  \*********************************************************************/
...
function childNodesGetterPatched() {
  if (this instanceof Element && isHostElement(this)) {
    ...
    if (undefined !== 'production' && isFalse$1(hasNativeSymbolsSupport$2) && isExternalChildNodeAccessorFlagOn()) {
...
const getInternalChildNodes = undefined !== 'production' && isFalse$1(hasNativeSymbolsSupport$2) ? function (node) {
...
function getInitializedFeatureFlags$1() {
  ...
  getElementsByClassName: {
    value() {
      ...
      if (runtimeFlags.ENABLE_HTML_COLLECTIONS_PATCH) {
        filteredResults = getFilteredArrayOfNodes(this, elements, ShadowDomSemantic.Enabled);
      } else {
...
const MO$1 = MutationObserver;
const MutationObserverObserve$1 = MO$1.prototype.observe;
